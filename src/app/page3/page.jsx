...
export default function Page3() {
  ...
  return (
    <main className="w-[100%] h-[100vh] sm:h-[100vh] xl:h-[100vh] bgTheme">
      <BackGround />
      <Header />
      <MenuList />
      <div className="w-[100%] h-[100%] absolute top-0 left-0 flex justify-center">
        <div className="w-[100%] h-[100%] 2xl:container flex justify-center items-center">
          <section className="w-[450px] p-7 rounded-xl bg-[rgb(13,12,24)]">
            ...
            <p className="w-[100%] flex justify-center text-[1rem] font-semibold colorTextParagraph1">
...
function BackGround() {
  return (
    <div className="w-[100%] h-[100%] absolute top-0 left-0 overflow-hidden">
      <div className="w-[100%] h-[80vh] sm:h-[80vh] lg:h-[80vh] bgTheme bgStake">
        <article className="w-[100%] h-[100%]  flex justify-center pt-[20vh]">
          {/* <div className="colorBackground  w-[60%] h-[20vh]  opacity-30 blur-[80px] "></div> */}
        </article>
      </div>

      <section className="w-[100%] h-[40vh] sm:h-[40vh] xl:h-[40vh] bgTheme">
