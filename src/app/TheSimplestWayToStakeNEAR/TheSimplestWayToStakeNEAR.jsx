...
function Article() {
  return (
    <article className="w-[100%] h-[220vh] lg:h-[80vh] flex flex-wrap justify-center lg:content-start lg:items-start py-3  lg:gap-20">
      ...
      <article className="w-[90%] lg:w-[25%] xl:w-[23%] h-[30%] lg:h-[82.5%] border-[.005px] border-[rgba(255,255,255,.03)] rounded-2xl backdropBlur2">
        ...
        <div className="w-[100%] h-[60%] p-10">
          ...
          <p className="w-[100%] text-[1rem] lg:text-[.9rem] xl:text-[1rem] text-zinc-300 pt-5">
