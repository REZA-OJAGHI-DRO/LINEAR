...
export default function Page4() {
  return (
    <main className="w-[100%] h-[105vh] sm:h-[180vh] xl:h-[122vh] bg-slate-900">
      <BackGround />
      <Header />
      <MenuList />
      <div className="w-[100%] h-[100%] absolute top-0 left-0 flex justify-center">
        <div className="w-[100%] h-[100%] 2xl:container ">
          ...
          <article className="w-[100%] h-[20vh] md:h-[30vh] xl:h-[22vh] flex flex-wrap justify-start content-end px-10">
            <h2 className="w-[100%] text-white font-bold text-[1.5rem] md:text-[1.7rem]">
            Omnichain Liquid (Re)Staking
            </h2>
            <p className="w-[100%] text-white text-[.8rem] md:text-[1rem]">
...
function BackGround() {
  return (
    <div className="w-[100%] h-[100%] absolute top-0 left-0 pt-[5vh]">
      ...
      <section className="w-[100%] h-[20vh] sm:h-[30vh] xl:h-[20vh] bg-[#0a0a10]">
      ...
      <section className="w-[100%] h-[80vh] sm:h-[145vh] xl:h-[97vh] overflow-hidden bg-[#0a0a10]">
        <div className="w-[100%] h-[100%] flex justify-center  backdropBlur">
